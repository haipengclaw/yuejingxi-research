...
EXCLUDE_NAME_TERMS = [
    ...
    '汽车', '宠物', '洗衣', '家政', '维修', '招聘', '人才', '电玩', '游戏城', '猫舍', 'DIY', '团建', '伴手礼', 'Helipad', 'Suki', '茶空间', '茶馆', '茶室', '万科云城', '十万伏特', '售票', '索道', '酒吧','鸡尾酒','cocktail','Cocktail','Whisky','whisky','清吧','音乐吧', 'KTV', '演艺', '演绎', '剧场', '影院', '广场', '商场', 'mall', '公园', '收藏品', '艺术空间', '野兽派',
]
