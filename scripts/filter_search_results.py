...
EXCLUDE_NAME_TERMS = [
    ...
    '密室','探影','iNS Pilates','普拉提','pilates','Pilates','北京路天河城','云门 NEW PARK','NEW PARK','小室志斋','士多啤梨','AD HAIR', '轰趴', '网吧', '采摘', '农家乐',
    # 其他非餐饮
    '园区', '工作室', '茶文化', '花店', '鲜花', '手作', '钓鱼', '母婴', '护理', '月子',
    '汽车', '宠物', '洗衣', '家政', '维修', '招聘', '人才', '咖啡','Coffee','Cafe','COFFEE','KUDDO','KONOMI','DECAMERON','十日谈','Home Cafe','旧里堂','豪先生','JuenHo','coffee','蛋糕','cake','Cake','烘焙','面包','Bread','甜品','甜点', '电玩', '游戏城', '猫舍', 'DIY', '团建', '伴手礼', 'Helipad', 'Suki', '茶空间', '茶馆', '茶室', '万科云城', '十万伏特', '售票', '索道', '酒吧','鸡尾酒','cocktail','Cocktail','Whisky','whisky','清吧','音乐吧', 'KTV', '演艺', '演绎', '剧场', '影院', '广场', '商场', 'mall', '公园', '收藏品', '艺术空间', '野兽派',
]
