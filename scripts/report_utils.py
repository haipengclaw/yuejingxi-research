...
.shop-banner h2{font-size:17px;font-weight:700;margin-bottom:2px;display:flex;align-items:center;gap:8px;flex-wrap:wrap}.detail-btn{display:inline-block;font-size:11px;background:#c0392b;color:#fff!important;padding:2px 10px;border-radius:12px;text-decoration:none;font-weight:400;white-space:nowrap}.detail-btn:hover{background:#a93226}
...
.select-hint{font-size:11px;color:#999;text-align:center;padding:4px 0 8px;border-bottom:1px solid #eee}
.footer{text-align:center;padding:20px;color:#999;font-size:12px}
@media(max-width:768px){.dish-grid{grid-template-columns:repeat(3,1fr)}.shop-banner h2{font-size:15px}.detail-btn{font-size:10px;padding:1px 8px}.score-grid{gap:6px;padding:8px 12px}.score-item .val{font-size:14px}.section{padding:10px 14px}.dish-card .dish-name{font-size:11px}}
...
function updateCount(){
  ...
  if(el)el.textContent=(JSON.parse(localStorage.getItem('researchList')||'[]')).length;
}
